...
<p>
	<?= Text::_('COM_ONTHOS_ISSUES_FIX_UNPROTECT') ?>
</p>
<form action="<?= Route::_('index.php?option=com_onthos&task=items.unprotect') ?>" method="post">
	...
	<p class="ps-3">
		<button type="submit" class="btn btn-primary">
			<?= Text::_('COM_ONTHOS_ITEM_LBL_TOOLBAR_UNPROTECT') ?>
		</button>
	</p>
</form>
